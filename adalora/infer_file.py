...
# 경로 설정
input_dir = "./train_dataset/modern"
depth_out_dir = "./depth_imgs"
seg_out_dir = "./seg_imgs"
final_out_dir = "./generated_imgs/coastal_30"
...
pipe.load_lora_weights(".", weight_name="./final-lora-weight/adalora_coastal/checkpoint-5000/adalora_weights.safetensors")
...
for img_path in image_paths:
    ...
    depth_scales = [0.7]
    seg_scales = [0.7]
    seed = 42  # 원하는 시드 값으로 고정
    generator = torch.manual_seed(seed)
    prompts = [
        f"a {V} style interior room, photorealistic, highly detailed",
    ]
    ...
    for p_idx, prompt in enumerate(prompts):
        for d_scale in depth_scales:
            for s_scale in seg_scales:
                ...
                out_path = os.path.join(final_out_dir, f"5000.jpg")
